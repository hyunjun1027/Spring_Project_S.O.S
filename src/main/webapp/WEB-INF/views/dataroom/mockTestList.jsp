...
<body>
	...
	<section class="notice-section">
		<div class="notice-content">
			<div class="notice-text">
				<h1 class="mainTitle">Mock Test</h1>
				<p class="mainContent">모의고사</p>
			</div>
	...
	<section class="content-section">
		<div class="sidebar">
			...
			<ul class="menu">
				<li><a href="/dataroom/mockTestList" class="highlight">모의고사</a></li>
				<!--                 <li>
			...
			<ul class="menu2">
				<li><a href="/dataroom/prevQueList">기출문제</a></li>
